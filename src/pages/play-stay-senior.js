...
function PlayStaySenior() {
  const [open, setOpen] = useState(false);

  return (
    <div className="flex flex-col md:flex-row gap-10 my-10 md:my-20 px-5 md:px-0">
      <div className="w-full md:w-1/2">
        <HeaderText text="Play & Stay Senior" />
        <div className="flex flex-col gap-6">
          <h2>
            Kostenloses Tennistraining für Erwachsene: <br /> Der TC Holzminden
            von 1928 öffnet seine Pforten
          </h2>

          <p>
            Der Tennisclub Holzminden von 1928 bietet eine großartige
            Gelegenheit für Erwachsene, den Tennissport zu entdecken.
          </p>
          <p>
            {" "}
            <strong>Montags und Mittwochs von 18:00 bis 19:00 Uhr</strong>{" "}
            findet an der Liebigstraße ein kostenloses Tennistraining statt, das
            allen interessierten Erwachsenen offensteht.{" "}
          </p>
          <p>
            Egal, ob Sie Anfänger sind oder bereits Erfahrung im Tennis haben,
            unser Training ist für alle Niveaus geeignet.
          </p>
          {/* 
...
export default PlayStaySenior;

PlayStaySenior.getLayout = function getLayout(page) {
