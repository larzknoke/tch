      ...
      <div className="w-full md:w-2/3">
        ...
        <div className="flex flex-col gap-6 my-10">
          <span className="flex flex-col gap-8">
            ...
            der Anschrift, EMail- Adresse oder Telefonnummer einer betroffenen
            Person, erfolgt stets im Einklang mit der
            Datenschutz-Grundverordnung und in Übereinstimmung mit den für die
            Tennisverein Holzminden von 1928 e.V.. geltenden landesspezifischen
            ...
            <nav className="text-sm bg-gray-100 p-4 rounded-md space-y-1">
              ...
              <ul className="list-disc list-inside space-y-1 columns-1 md:columns-2 gap-4">
                ...
                <li>
                  <a href="#berechtigte-interessen" className="hover:underline">
            ...
            <h2 id="begrifflichkeiten" className="mt-10 text-xl font-semibold">
              1. Begriffsbestimmungen{" "}
              <a
                href="#top"
            ...
            <br />
            Die Datenschutzerklärung der Tennisverein Holzminden von 1928 e.V..
            beruht auf den
            <br />
            ...
            <ul className="list-disc list-inside space-y-4 mt-4">
              ...
              <li>
                <strong>f) Pseudonymisierung:</strong> Pseudonymisierung ist die
              ...
              <li>
                <strong>h) Auftragsverarbeiter:</strong> Auftragsverarbeiter ist
              ...
              <li>
                <strong>k) Einwilligung:</strong> Einwilligung ist jede von der
            ...
            in den
            <br />
            Mitgliedstaaten der Europäischen Union geltenden Datenschutzgesetze
            und anderer
            <br />
            ...
            <br />
            Die Internetseite der Tennisverein Holzminden von 1928 e.V.. erfasst
            mit jedem Aufruf der
            <br />
            Internetseite durch eine betroffene Person oder ein automatisiertes
            System eine Reihe von
            <br />
            ...
            werden durch die
            <br />
            Tennisverein Holzminden von 1928 e.V.. daher einerseits statistisch
            und ferner mit dem Ziel
            <br />
            ...
            <br />
            Die Internetseite der Tennisverein Holzminden von 1928 e.V.. enthält
            aufgrund von
            <br />
            ...
            hinterlassenen
            <br />
            Kommentaren auch Angaben zum Zeitpunkt der Kommentareingabe sowie zu
            dem von der
            <br />
            betroffenen Person gewählten Nutzernamen (Pseudonym) gespeichert und
            veröffentlicht.
            <br />
            Ferner wird die vom Internet-Service-Provider (ISP) der betroffenen
            Person vergebene IPAdresse
            <br />
            mitprotokolliert. Diese Speicherung der IP-Adresse erfolgt aus
            Sicherheitsgründen
            <br />
            und für den Fall, dass die betroffene Person durch einen abgegebenen
            Kommentar die Rechte
            <br />
            ...
            <br />
            keine Weitergabe dieser erhobenen personenbezogenen Daten an Dritte,
            sofern eine solche
            <br />
            ...
            <br />o das Bestehen eines Rechts auf Berichtigung oder Löschung der
            sie
            <br />
            ...
            <br />o Die personenbezogenen Daten wurden für solche Zwecke erhoben
            oder auf
            <br />
            ...
            Gründe für
            <br />
            die Verarbeitung vor, oder die betroffene Person legt gemäß Art. 21
            Abs. 2<br />
            DS-GVO Widerspruch gegen die Verarbeitung ein.
            <br />o Die personenbezogenen Daten wurden unrechtmäßig verarbeitet.
            ...
            <br />o Der Verantwortliche benötigt die personenbezogenen Daten für
            die Zwecke
            <br />
            ...
            <br />o Die betroffene Person hat Widerspruch gegen die Verarbeitung
            gem. Art. 21
            <br />
            ...
            DS-GVO oder
            <br />
            Art. 9 Abs. 2 Buchstabe a DS-GVO oder auf einem Vertrag gemäß Art. 6
            Abs. 1<br />
            ...
            hat das vom
            <br />
            Europäischen Richtlinien- und Verordnungsgeber gewährte Recht, nicht
            einer
            <br />
            ...
            <br />
            integriert. Google AdSense ist ein Online-Dienst, über welchen eine
            Vermittlung von
            <br />
            ...
            der IP-Adresse der
            <br />
            betroffenen Person, die der Alphabet Inc. unter anderem dazu dienen,
            die Herkunft der
            <br />
            ...
            verhindern, dass die
            <br />
            Alphabet Inc. ein Cookie auf dem informationstechnologischen System
            der betroffenen
            <br />
            Person setzt. Zudem kann ein von der Alphabet Inc. bereits gesetzter
            ...
            <br />
            Analytics (mit Anonymisierungsfunktion) integriert. Google Analytics
            ist ein Web-Analyse-
            <br />
            ...
            <br />
            Daten darüber, von welcher Internetseite eine betroffene Person auf
            eine Internetseite
            <br />
            ...
            wurde. Eine Web-
            <br />
            Analyse wird überwiegend zur Optimierung einer Internetseite und zur
            Kosten-Nutzen-
            <br />
            ...
            <br />
            On teilt Google Analytics über JavaScript mit, dass keine Daten und
            ...
            späteren Zeitpunkt
            <br />
            gelöscht, formatiert oder neu installiert, muss durch die betroffene
            Person eine erneute
            <br />
            ...
            genauer erläutert.
            <br />
            <h2 id="google-remarketing" className="mt-10 text-xl font-semibold">
            ...
            der IP-Adresse des
            <br />
            von der betroffenen Person genutzten Internetanschlusses, an Google
            in den Vereinigten
            <br />
            ...
            <br />
            durch Google zu widersprechen. Hierzu muss die betroffene Person von
            jedem der von ihr
            <br />
            ...
            durch die
            <br />
            Einblendung von interessenrelevanter Werbung auf den Internetseiten
            ...
            <br />
            dem informationstechnologischen System der betroffenen Person durch
            Google ein
            <br />
            ...
            <br />
            von Google verwendet, um Besuchsstatistiken für unsere Internetseite
            zu erstellen. Diese
            <br />
            ...
            dass der von der
            <br />
            betroffenen Person verwendete Browser eine entsprechende Darstellung
            der Komponente von
            <br />
            ...
            <br />
            betroffenen Person zugeordnet. Betätigt die betroffene Person einen
            auf unserer Internetseite
            <br />
            integrierten LinkedIn-Button, ordnet LinkedIn diese Information dem
            persönlichen LinkedIn-
            <br />
            ...
            <br />
            abgelehnt werden. Die geltenden Datenschutzbestimmungen von LinkedIn
            sind unter
            <br />
            ...
            <br />
            durch die betroffene Person besucht wird. Zweck der Integration der
            Twitter-Komponente ist
            <br />
            ...
            <br />
            persönlichen Twitter-Benutzerkonto der betroffenen Person zugeordnet
            und von Twitter
            <br />
            gespeichert und verarbeitet.
            <br />
            ...
            <br />
            Ist eine derartige Übermittlung dieser Informationen an Twitter von
            ...
            <br />
            YouTube und Google gesammelt und dem jeweiligen YouTube-Account der
            betroffenen
            <br />
            Person zugeordnet.
            <br />
            ...
            <br />
            Person zum Zeitpunkt des Aufrufs unserer Internetseite gleichzeitig
            bei YouTube eingeloggt
            <br />
            ist; dies findet unabhängig davon statt, ob die betroffene Person
            ein YouTube-Video anklickt
            <br />
            oder nicht. Ist eine derartige Übermittlung dieser Informationen an
            YouTube und Google von
            <br />
            ...
            bestimmten
            <br />
            Verarbeitungszweck einholen. Ist die Verarbeitung personenbezogener
            Daten zur Erfüllung
            <br />
