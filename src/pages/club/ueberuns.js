      ...
      <div className="w-full md:w-1/2">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              Der Trainingsbetrieb für Kinder findet täglich von 14:00 bis 18:00
              Uhr auf der Anlage an der Liebigstraße 111 statt. Ein wichtiger
              Meilenstein in der Entwicklung des Vereins war der Kauf der
              Tennishalle am Stahler Ufer, der vor zwei Jahren dank
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              ...
              Trainer arbeiten eng mit den Kindern zusammen, um ihre Fähigkeiten
              zu verbessern. Im Erwachsenenbereich konnte Mischa Pietrzyk als
              Trainer gewonnen werden, was zu einer starken Steigerung der
              Mitgliederzahlen geführt hat.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              ...
              und einem engagierten Vorstand ist der Verein gut aufgestellt, um
